      ...
      <div className="max-w-2xl mx-auto flex flex-col gap-4 pt-4">
        <div className="space-y-4">
          ...
          <div className="flex justify-between text-sm">
            <div className="text-muted-foreground">{charCount.toLocaleString()} characters (min. 1000, max. 10000)</div>
        ...
        <div className="flex flex-col md:flex-row justify-end gap-4 mx-auto mt-4">
          <Button disabled={sourceText.length === 0 || isLoading} variant="outline" size="lg" onClick={reset}>
            Reset form
          </Button>
          <Button type="submit" disabled={!isValidLength || isLoading} size="lg">
